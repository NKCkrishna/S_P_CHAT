...
# Try to load secrets, with fallback to environment variables
try:
...
st.markdown("""
    <div style='text-align: center; margin-bottom: 2rem;'>
        <h2>Your Sustainable Agriculture and Energy Management Assistant</h2>
    </div>
...
with st.sidebar:
    ...
    st.header("About")
    st.markdown("""
        SustainifyAI helps you make sustainable decisions for agriculture and energy management.
        - Get weather forecasts
        - Analyze NDVI data
        - Receive agricultural suggestions
        - Get energy management recommendations
